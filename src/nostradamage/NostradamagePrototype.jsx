...
export default function NostradamagePrototype() {
  ...
  if (error) {
   ...
   const [UFCEvents, setUFCEvents] = useState(['UFC_312_Du_Plessis_vs_Strickland_2_', 'UFC_311_Makhachev_vs_Moicano','UFC_Fight_Night_Covington_vs_Buckley', 'UFC_309', 'UFC_Fight_Night_Yan_vs_Figueiredo']);
